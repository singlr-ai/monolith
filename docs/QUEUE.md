...
See [`docs/design/QUEUE.md`](design/QUEUE.md) for the precise guarantees and the claim algorithm.
...
[`Observability`](OBSERVABILITY.md) seam as the runtime (they extend `MonolithEvent.Extension`), so a
