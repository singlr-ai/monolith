---
title: "Scaling Monolith"
description: "Monolith builds on Postgres, so it scales the way a Postgres application scales: one primary takes writes, and you add capacity around it."
---
