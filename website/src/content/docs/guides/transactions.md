---
title: "Transactions"
description: "Tx.tx runs a unit of work inside a single database transaction: it issues BEGIN, runs your work, and then COMMITs a success or ROLLBACKs a failure."
---
